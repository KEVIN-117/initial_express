...
router.get('/products/:id', validateSchema(getProductSchema, 'params'), product)
router.patch('/products/:id', validateSchema(getProductSchema, 'params'), validateSchema(updateProduct, 'body'), updateProduct)
router.delete('/products/:id', validateSchema(getProductSchema, 'params'), deleteProduct)
